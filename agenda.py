...
class UserAgenda(StateTracker):
    ...
    def step(self, s, sys_a):
        ...
        return next_s, terminal, {'wm_state': current_s, 'wm_usr_a_vec': usr_a, 'wm_usr_terminal': terminal}
...
class Goal(object):
    ...
    def __init__(self, goal_generator: GoalGenerator, mask_user_goal, seed=None):
        """
